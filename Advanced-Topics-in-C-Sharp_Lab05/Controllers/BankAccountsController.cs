...
namespace Advanced_Topics_in_C_Sharp_Lab05.Controllers
{
    ...
    public class BankAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Balance,UserId")] BankAccount bankAccount)
        {
            ...
            {
                ViewBag.Message = "cannot be set to less than 0";
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<ApplicationUser>(), "Id", "Id", bankAccount.UserId);
            return View(bankAccount);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Advanced_Topics_in_C_Sharp_Lab05Context.BankAccount'  is null.");
            }
            var bankAccount = await _context.BankAccounts.FindAsync(id);
            if (bankAccount != null)
            {
